...
export const citiesByCountry: Record<string, string[]> = {
  ...
  FR: ["Paris", "Marseille", "Lyon", "Toulouse", "Nice", "Nantes", "Strasbourg", "Montpellier", "Bordeaux", "Lille", "Rennes", "Grenoble", "Rouen", "Toulon", "Reims", "Saint-Étienne", "Le Havre", "Dijon", "Angers", "Villeurbanne", "Nîmes", "Clermont-Ferrand", "Aix-en-Provence", "Le Mans", "Brest", "Tours", "Amiens", "Limoges", "Annecy", "Perpignan", "Boulogne-Billancourt", "Orléans", "Metz", "Besançon", "Mulhouse", "Caen", "Argenteuil", "Saint-Denis", "Montreuil", "Nancy", "Roubaix", "Tourcoing", "Avignon", "Dunkerque", "Créteil", "Poitiers", "Fort-de-France", "Versailles", "Courbevoie", "Vitry-sur-Seine", "Colombes", "Pau", "Aulnay-sous-Bois", "Asnières-sur-Seine", "Rueil-Malmaison", "Antibes", "Saint-Maur-des-Fossés", "Calais", "Cannes", "Béziers", "Compiègne", "Beauvais", "Senlis", "Chantilly", "Creil", "Noyon", "Soissons", "Laon", "Saint-Quentin", "Charleville-Mézières", "Troyes", "Châlons-en-Champagne", "Épernay", "Auxerre", "Nevers", "Mâcon", "Chalon-sur-Saône", "Belfort", "Colmar", "Haguenau", "Thionville", "Forbach", "Épinal", "Saint-Dié-des-Vosges", "Bar-le-Duc", "Verdun", "Charleville-Mézières", "Sedan", "Lunéville", "Sarrebourg", "Sarreguemines", "Saint-Avold", "Montbéliard", "Pontarlier", "Dole", "Lons-le-Saunier", "Vesoul", "Gray", "Luxeuil-les-Bains", "Héricourt"],
