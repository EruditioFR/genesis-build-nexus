        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              entre MemoriaVita et ses utilisateurs pour la souscription aux services payants proposés 
              sur la plateforme.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              MemoriaVita propose les abonnements suivants :
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              MemoriaVita s'engage à fournir les services avec diligence. Nous ne pouvons être tenus 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Pour toute question relative aux CGV, contactez-nous à : contact@memoriavita.com
            </p>
          </section>
        </div>
      </div>
