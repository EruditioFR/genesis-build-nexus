        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <div className="text-muted-foreground leading-relaxed space-y-2">
              <p><strong>Nom de la société :</strong> MemoryVitae SAS</p>
              ...
              <p><strong>Email :</strong> contact@memoryvitae.com</p>
            ...
            <div className="bg-muted/50 rounded-lg p-6 space-y-6">
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 ml-6">
                  <p><strong>Plateforme :</strong> Lovable</p>
                  <p><strong>Infrastructure :</strong> Supabase sur Amazon Web Services (AWS)</p>
                  <p><strong>Région de stockage :</strong> Union Européenne (eu-west-1 Irlande / eu-central-1 Francfort)</p>
                  <p><strong>Site web :</strong> <a href="https://lovable.dev" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://lovable.dev</a></p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 ml-6">
                  ...
                  <p><strong>Infrastructure :</strong> Amazon Web Services (AWS)</p>
                  <p><strong>Région :</strong> Union Européenne</p>
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 ml-6">
                  <p><strong>Fournisseur :</strong> Amazon Web Services (AWS)</p>
                  <p><strong>Région :</strong> Europe (Irlande eu-west-1, Francfort eu-central-1)</p>
                  <p><strong>Site web :</strong> <a href="https://aws.amazon.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://aws.amazon.com</a></p>
                  <div className="flex flex-wrap gap-2 mt-2">
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 ml-6">
                  <p><strong>Société :</strong> Stripe, Inc.</p>
                  <p><strong>Adresse :</strong> 354 Oyster Point Boulevard, South San Francisco, CA 94080, USA</p>
                  <p><strong>Site web :</strong> <a href="https://stripe.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://stripe.com</a></p>
                  <div className="flex flex-wrap gap-2 mt-2">
                    <Badge variant="secondary">PCI DSS Level 1</Badge>
              ...
              <div>
                ...
                <div className="text-muted-foreground space-y-1 ml-6">
                  <p><strong>Société :</strong> Resend Inc.</p>
                  <p><strong>Site web :</strong> <a href="https://resend.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://resend.com</a></p>
                  <div className="flex flex-wrap gap-2 mt-2">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Conformément à l'article 28 du RGPD, nous faisons appel aux sous-traitants suivants pour le traitement de vos données :
            </p>
              ...
              <table className="w-full border-collapse border border-border rounded-lg">
                <thead>
                  <tr className="bg-muted">
                    ...
                    <th className="border border-border px-4 py-3 text-left text-foreground font-semibold">Localisation</th>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mt-4">
              ...
              <ul className="text-muted-foreground space-y-1 text-sm">
                <li>• <strong>Clauses Contractuelles Types (CCT)</strong> approuvées par la Commission Européenne (Décision 2021/914)</li>
                <li>• <strong>Data Privacy Framework (DPF)</strong> pour les entreprises américaines certifiées</li>
                <li>• <strong>Mesures supplémentaires</strong> : chiffrement de bout en bout, pseudonymisation des données</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              etc.) est la propriété exclusive de MemoryVitae ou de ses partenaires. Toute reproduction, 
              ...
              soit est interdite sans autorisation écrite préalable de MemoryVitae.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              ...
              <p className="text-muted-foreground">Email : <a href="mailto:dpo@memoryvitae.com" className="text-primary hover:underline">dpo@memoryvitae.com</a></p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Ce site peut contenir des liens vers d'autres sites web. MemoryVitae n'est pas responsable 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:contact@memoryvitae.com" className="text-primary hover:underline ml-1">contact@memoryvitae.com</a>
            </p>
          </section>
