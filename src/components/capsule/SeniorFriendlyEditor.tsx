...
const STEPS = [
  { id: 'title', icon: FileText, color: 'text-blue-600', bgColor: 'bg-blue-100' },
  { id: 'content', icon: Image, color: 'text-green-600', bgColor: 'bg-green-100' },
  { id: 'details', icon: FolderOpen, color: 'text-purple-600', bgColor: 'bg-purple-100' },
  { id: 'finish', icon: Check, color: 'text-amber-600', bgColor: 'bg-amber-100' },
] as const;
...
const SeniorFriendlyEditor = ({
  ...
  const InfoTip = ({ text }: { text: string }) => (
    <Tooltip>
      <TooltipTrigger asChild>
        <button 
          type="button" 
          className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-muted hover:bg-muted/80 ml-2"
        >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                ...
                className="min-h-[120px] text-lg px-5 py-4 border-2 focus:border-secondary resize-none"
                value={description}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              <Section
                id="text"
                icon={FileText}
                title={t('seniorEditor.textTitle', 'Écrire un texte')}
                description={t('seniorEditor.textDesc', 'Lettre, histoire, anecdote...')}
                badge={content.trim() ? '✓' : undefined}
              >
                <Textarea
                  placeholder={t('seniorEditor.textPlaceholder', 'Écrivez votre texte ici...')}
                  className="min-h-[200px] text-lg px-4 py-3 border-2 focus:border-secondary resize-none"
                  value={content}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              <Section
                id="category"
                icon={FolderOpen}
                title={t('seniorEditor.categoryTitle', 'Catégorie')}
                description={t('seniorEditor.categoryDesc', 'Dans quelle catégorie classer ce souvenir ?')}
                badge={primaryCategory ? '✓' : undefined}
              >
                <CategorySelector
              ...
              <Section
                id="date"
                icon={Calendar}
                title={t('seniorEditor.dateTitle', 'Date du souvenir')}
                description={t('seniorEditor.dateDesc', 'Quand ce souvenir a-t-il eu lieu ?')}
                badge={memoryDate ? '✓' : undefined}
              >
                <div className="pt-2">
                  <MemoryDateSelector
                    value={memoryDate}
              ...
              <Section
                id="tags"
                icon={Tag}
                title={t('seniorEditor.tagsTitle', 'Mots-clés')}
                description={t('seniorEditor.tagsDesc', 'Ajoutez des mots pour retrouver facilement ce souvenir')}
        ...
        return (
          <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    ...
                    {!content.trim() && photoCount === 0 && videoCount === 0 && audioCount === 0 && !youtubeUrl && (
                      <span className="text-muted-foreground italic">Aucun contenu ajouté</span>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4 pt-4">
              <Button
                size="lg"
                className="w-full h-16 text-xl gap-3 bg-gradient-to-r from-secondary to-secondary/80 hover:opacity-90 text-white shadow-lg"
                onClick={onPublish}
                disabled={isSaving}
              >
  ...
  return (
    <div className="min-h-screen bg-gradient-warm">
      ...
      {currentStep < 3 && (
        <div className="fixed bottom-0 left-0 right-0 bg-card/95 backdrop-blur-sm border-t-2 border-border p-4">
