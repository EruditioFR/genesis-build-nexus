      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <Button
            ...
            className="w-[80vw] sm:w-auto bg-gradient-to-r from-[hsl(var(--accent))] to-[hsl(var(--terracotta))] hover:opacity-90 text-white text-sm sm:text-lg px-8 py-6 rounded-xl shadow-2xl shadow-[hsl(var(--accent))]/30 hover:shadow-[hsl(var(--accent))]/50 transition-all h-auto min-h-11"
          >
