          ...
          >
            <div className="relative">
              ...
              <button
                ...
                aria-label={t('v3.videoPreview.playLabel')}
              ...
              >
                ...
                <div className="relative aspect-video bg-black">
                  <img
                    ...
                    alt={t('v3.videoPreview.imageAlt')}
        ...
        {isOpen && (
          ...
          >
            ...
            >
              <button
                onClick={handleClose}
                aria-label={t('v3.videoPreview.closeLabel')}
              ...
              <iframe
                ...
                title={t('v3.videoPreview.iframeTitle')}
