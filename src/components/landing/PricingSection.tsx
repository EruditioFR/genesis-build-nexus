    ...
    <section id="pricing" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <span
              className={`absolute top-1 w-5 h-5 rounded-full bg-card shadow-sm transition-transform duration-300 ${
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-3xl p-8 ${
                plan.popular
                  ? "bg-primary text-primary-foreground shadow-elevated scale-105 z-10"
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="px-4 py-1.5 rounded-full bg-secondary text-secondary-foreground text-sm font-semibold shadow-gold">
                    Le plus populaire
                  </span>
                </div>
              )}
              ...
              <div className="text-center mb-8">
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4 ${
                  ...
                  <plan.icon className={`w-7 h-7 ${plan.popular ? "text-secondary" : "text-primary"}`} />
                </div>
