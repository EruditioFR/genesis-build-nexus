  ...
  return <section id="how-it-works" className="py-16 sm:py-24 bg-card relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        duration: 0.6
          ...
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-display font-bold text-foreground mb-4 sm:mb-6">Créez votre héritage en <span className="text-secondary">4 étapes simples</span>
          </h2>
        </motion.div>
